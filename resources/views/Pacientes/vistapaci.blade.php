...
<head>
    ...
    <title>Lista de Pacientes - DocHome</title>
</head>
                    ...
                    <section class="tabladoc container ">
                        <table style="width:99% ">
                            <tr>
                                ...
                                <td>
                                    <p class="container d-flex justify-content-center"> Anglea Zemanate</p>
                                </td>
                                <td>
                    ...
                    <section class=" tabladoc container ">
                        <table style="width:99% ">
                            <tr>
                                ...
                                <td>
                                    <p class="container d-flex justify-content-center"> Sofia Ceron</p>
                                </td>
                                <td>
                                    <p class="container d-flex justify-content-center"> </p>
                                </td>
                    ...
                    <section class="tabladoc container ">
                        <table style="width:99% ">
                            <tr>
                                ...
                                <td>
                                    <p class="container d-flex justify-content-center"> Ricardo Mera</p>
                                </td>
                                <td>
